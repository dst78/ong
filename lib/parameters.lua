...
function Params.init()
  ...
  params:add_control("nearWavesFilterCutoff", "filter freq", controlspec.new(20, 5000, "exp", 0, 3000, "hz"))
  ...
  params:add_control("farWavesFilterCutoff", "filter freq", controlspec.new(20, 5000, "exp", 0, 840, "hz"))
  ...
  params:add_number("foghornProbability", "foghorn probability", 1, 50, 5)
  ...
  params:add_number("thunderSize", "thunder size", 1, 1000, 270)
